...
public class SciFiAdapter extends RecyclerView.Adapter<SciFiAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@androidx.annotation.NonNull MyViewHolder holder, int position) {
        ...
        holder.imageView.setOnClickListener(view -> {
            ...
            sendData2Detail.putExtra("title",dataModels.get(position).getSFtitle());
            sendData2Detail.putExtra("country",dataModels.get(position).getSFcountry());
            sendData2Detail.putExtra("cover",dataModels.get(position).getSFcover());
            sendData2Detail.putExtra("desc",dataModels.get(position).getSFdesc());
            sendData2Detail.putExtra("eps",dataModels.get(position).getSFeps());
            sendData2Detail.putExtra("length",dataModels.get(position).getSFlength());
            sendData2Detail.putExtra("link",dataModels.get(position).getSFlink());
            sendData2Detail.putExtra("rating",dataModels.get(position).getSFrating());
            //sendData2Detail.putExtra("thumb",dataModels.get(position).getAthumb());
            sendData2Detail.putExtra("cast",dataModels.get(position).getSFcast());
