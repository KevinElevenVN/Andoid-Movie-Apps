...
public class MovieAdapter extends SliderViewAdapter<MovieAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends SliderViewAdapter.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            ...
            feature_title=itemView.findViewById(R.id.feature_title);
